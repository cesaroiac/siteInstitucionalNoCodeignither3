<div class="col-md-12 col-contato bg-default" id="contato">
    <div class="row align-items-center no-gutters justify-content-md-center">
        <div class="col-md-4 bg-white shadow-lg rounded p-4 mt-5 mb-5">
            <form action="#" method="post">
                <div class="row justify-content-md-center">
                    <h2 class="header-title mt-4 text-orange mb-4 col-md-12">Contate-nos</h2>
                    <br>
                    <div class="col-md-12">
                    ...
                    <div class="col-md-12 mb-3 mt-4">
                        <button type="submit" class="btn btn-orange mb-3" name="button">
                            Enviar
                        </button>
                    </div>
                </div>
        ...
        <div class="col-md-4 p-4 mt-5 mb-5 bg-orange shadow rounded">
            <h5 class="text-light mt-2 mb-2">O que acontece depois?</h5>
            <p class="text-light mt-2 mb-2"><strong>1. </strong>Primeira instrução de exemplo.</p>
            <p class="text-light mt-2 mb-2"><strong>2. </strong>Segunda instrução de exemplo.</p>
        </div>  
    </div>
</div>
